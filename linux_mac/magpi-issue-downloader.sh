...
source /dev/stdin <<<"$(curl -s https://raw.githubusercontent.com/joergi/downloader/special_edition_changes/linux_mac/downloader.sh)" "$downloadUrl" "$OUTDIR" "$recentIssue" "$@"
